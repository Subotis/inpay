...
RSpec.describe DirectDebitPaymentCreditor, type: :model do
  ...
  describe "valid record" do
    subject { build(:direct_debit_payment_creditor) }
    it { should be_valid }
  end
  describe "non bic" do
    subject { build(:direct_debit_payment_creditor, :nonbic) }
    it { should be_invalid }
  end
  describe "non iban" do
    subject { build(:direct_debit_payment_creditor, :noniban) }
    it { should be_invalid }
  end
